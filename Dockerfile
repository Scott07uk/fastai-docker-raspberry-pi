...
COPY torch-1.5.0a0+3c31d73-cp37-cp37m-linux_armv7l.whl .
COPY torchvision-0.6.0a0+fe36f06-cp37-cp37m-linux_armv7l.whl .
RUN pip3 install numpy
RUN python3 -m pip install Pillow==6.1
RUN pip3 install torch-1.5.0a0+3c31d73-cp37-cp37m-linux_armv7l.whl
RUN pip3 install torchvision-0.6.0a0+fe36f06-cp37-cp37m-linux_armv7l.whl
